...
| `lbm_mrt_validation` | LBM-MRT D2Q9 independent solver | Ghia-validated; injection of PINN controls; branch admissibility (Fourier quasi-static, Chebyshev fluctuation-dominated) — completed: nine production/verification cases at Re=500/1000 converged to Δu<10⁻⁹ (see `pof1_converged/`) |
